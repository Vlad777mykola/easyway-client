...
export const AddXmlFile = ({ tableWords, setTableWords }: { tableWords: CreateWordDto[] }) => {
	const [xmlInputError, setXmlInputError] = useState('');

	const parseXML = (xmlString: string) => {
		console.error(xmlString, tableWords, setXmlInputError, 'Unknown error during JSON parsing');
		try {
	...
	return (
		...
		<FieldGroup marginY="03" title="Send XML file">
			<Input type="file" accept=".xml" size="middle" />
		</FieldGroup>
	);
};
